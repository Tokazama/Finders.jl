...
@inline function unsafe_findvalue(val, r::OneTo, rounding_mode=RoundToZero)
...
@inline function unsafe_findvalue(val, r::StepRangeLen, rounding_mode=RoundToZero)
...
@inline function unsafe_findvalue(val, r::LinRange, rounding_mode=RoundToZero)
